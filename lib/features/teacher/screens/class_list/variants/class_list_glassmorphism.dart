        ...
        child: Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: TextStyle(color: Colors.white.withOpacity(0.4), fontSize: 12, fontWeight: FontWeight.w700),
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(16),
                            boxShadow: [BoxShadow(color: const Color(0xFF60A5FA).withOpacity(0.3), blurRadius: 10)],
                          ),
                          child: Center(
                            child: Text(
  ...
  Widget _buildEmptyState(Map<String, dynamic> tokens) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Iconsax.radar, size: 64, color: Colors.white.withOpacity(0.3)),
          const SizedBox(height: 16),
          const Text('NOTHING FOUND IN SPACE', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 16)),
          Text('WIDEN YOUR PARAMETERS', style: TextStyle(color: Colors.white.withOpacity(0.6), fontWeight: FontWeight.w700, fontSize: 11)),
        ],
      ),
    );
  }
