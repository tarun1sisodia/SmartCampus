...
class SessionDetailsFluent extends StatelessWidget {
  ...
  const SessionDetailsFluent(
      {super.key, required this.controller, required this.classDetails});
    ...
    return Container(
      ...
      child: Obx(() {
        ...
        if (controller.session.value == null) {
          return const Center(
              child: Text('LOG_FILE_STREAM_ERROR',
                  style: TextStyle(color: Color(0xFF8A8886))));
        }
        ...
        return ListView(
          ...
          children: [
            ...
            const Text('Academic Attendance Record',
                style: TextStyle(
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Expanded(
                  child: Text(classDetails['subjectName'] ?? 'Unit Module',
          ...
          Text(
              '${classDetails['courseName']} | Semester ${classDetails['semester']}',
              style: TextStyle(
          ...
          Row(
            children: [
              _buildFluentMeta(
                  Iconsax.calendar_1, controller.formatDate(session.date)),
              const SizedBox(width: 24),
              _buildFluentMeta(
                  Iconsax.clock, '${session.startTime} - ${session.endTime}'),
            ],
          ),
        ],
      ),
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              _buildFluentStatNode(
                  'TOTAL', stats.total, const Color(0xFF201F1E)),
              _buildFluentStatNode(
                  'PRESENT', stats.present, const Color(0xFF0078D4)),
  ...
  Widget _buildFluentRoster() {
    ...
    if (records.isEmpty) {
      return Center(
          child: Text('No records stream found',
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              ...
              leading: CircleAvatar(
                ...
                child: Icon(
                    record.isPresent ? Iconsax.verify : Iconsax.close_circle,
              ...
              title: Text(record.studentName,
                  style: const TextStyle(
                      ...
                      fontSize: 14,
                      color: Color(0xFF201F1E))),
              subtitle: Text('NodeID: ${record.studentId}',
                  style: TextStyle(
                      fontWeight: FontWeight.w600,
                      fontSize: 11,
                      color: Colors.black.withValues(alpha: 0.4))),
              trailing: controller.isSessionActive()
                  ? Switch(
                      ...
                      onChanged: (v) =>
                          controller.toggleAttendance(record.id, v),
