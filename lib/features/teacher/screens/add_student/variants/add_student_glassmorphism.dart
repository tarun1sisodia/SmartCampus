  ...
  Widget _buildGlassEmptyState(BuildContext context) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Iconsax.user_add, size: 80, color: Colors.white.withOpacity(0.3)),
  ...
  Widget _buildGlassActionBtn(String label, IconData icon, VoidCallback onTap) {
    return InkWell(
       ...
       child: Container(
          ...
          decoration: BoxDecoration(color: Colors.white.withOpacity(0.1), border: Border.all(color: Colors.white.withOpacity(0.3)), borderRadius: BorderRadius.circular(16)),
          child: Row(
  ...
  Widget _buildGlassStudentCard(BuildContext context, dynamic student) {
    ...
    return Container(
      ...
      child: ListTile(
         ...
         subtitle: Text('NODE_ID: ${student.rollNumber}'.toUpperCase(), style: TextStyle(fontWeight: FontWeight.w700, fontSize: 9, color: Colors.white.withOpacity(0.5))),
    ...
    Get.dialog(
       BackdropFilter(
          ...
          child: AlertDialog(
             ...
             shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(32), border: Border.all(color: Colors.white.withOpacity(0.2))),
                   ...
                   children: [
                      Obx(() => GestureDetector(
                         ...
                         child: Container(
                            ...
                            decoration: BoxDecoration(color: Colors.white.withOpacity(0.05), border: Border.all(color: Colors.white.withOpacity(0.2)), borderRadius: BorderRadius.circular(24)),
             ...
             actions: [
                ...
                ElevatedButton(
                   ...
                   style: ElevatedButton.styleFrom(backgroundColor: Colors.white.withOpacity(0.15), foregroundColor: Colors.white, elevation: 0, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16), border: Border.all(color: Colors.white30))),
  ...
  Widget _buildGlassInput(TextEditingController ctrl, String label, IconData icon) {
    return TextFormField(
       ...
       decoration: InputDecoration(
          labelText: label,
          labelStyle: TextStyle(color: Colors.white.withOpacity(0.4), fontWeight: FontWeight.w900, fontSize: 9),
