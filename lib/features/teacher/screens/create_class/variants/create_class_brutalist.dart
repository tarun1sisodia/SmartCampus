      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: Icon(icon, color: Colors.black, size: 24),
            filled: true, fillColor: Colors.white,
            border: const OutlineInputBorder(borderRadius: BorderRadius.circular(0), borderSide: BorderSide(color: Colors.black, width: 2.5)),
            enabledBorder: const OutlineInputBorder(borderRadius: BorderRadius.circular(0), borderSide: BorderSide(color: Colors.black, width: 2.5)),
            focusedBorder: const OutlineInputBorder(borderRadius: BorderRadius.circular(0), borderSide: BorderSide(color: Colors.black, width: 4)),
            contentPadding: const EdgeInsets.symmetric(horizontal: 20, vertical: 16),
          ),
        ),
      ],
