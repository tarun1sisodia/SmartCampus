...
class AllSessionsGlassmorphism extends StatelessWidget {
              ...
              Expanded(
                child: Obx(() {
                  ...
                  if (controller.filteredSessions.isEmpty) {
                    return Center(
                      child: Text('VOID_REGISTRY', style: TextStyle(color: Colors.white.withOpacity(0.5), fontWeight: FontWeight.w900, fontSize: 13, letterSpacing: 1.5)),
                    );
                  }
  ...
  Widget _buildGlassSearchHUD(Map<String, dynamic> tokens) {
    return Container(
      ...
      decoration: BoxDecoration(color: Colors.white.withOpacity(0.1), border: Border(bottom: BorderSide(color: Colors.white.withOpacity(0.2)))),
      child: Row(
        children: [
          Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(color: Colors.white.withOpacity(0.05), borderRadius: BorderRadius.circular(16), border: Border.all(color: Colors.white.withOpacity(0.2))),
              child: TextField(
                controller: controller.searchController,
                style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 13),
                decoration: InputDecoration(
                  hintText: 'SYNC_SEARCH_QUERY...',
                  hintStyle: TextStyle(color: Colors.white.withOpacity(0.3), fontWeight: FontWeight.w800, fontSize: 10),
  ...
  Widget _buildGlassSessionCard(dynamic session, Map<String, dynamic> tokens) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: isSelected ? Colors.white : Colors.white.withOpacity(0.2), width: isSelected ? 2 : 1),
      ),
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          subtitle: Text(
            ...
            style: TextStyle(fontWeight: FontWeight.w700, fontSize: 10, color: Colors.white.withOpacity(0.5)),
          ),
          trailing: Container(
            width: 10,
            height: 10,
            decoration: BoxDecoration(color: isRunning ? const Color(0xFF10B981) : Colors.white.withOpacity(0.2), shape: BoxShape.circle, boxShadow: isRunning ? [const BoxShadow(color: Color(0xFF10B981), blurRadius: 10)] : null),
          ),
          children: [
            Padding(
              padding: const EdgeInsets.all(20),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 12),
                      _buildActionIcon(Iconsax.trash, Colors.white.withOpacity(0.2), () => controller.deleteSession(session.id)),
                    ],
                  ),
                ],
              ),
  ...
  Widget _buildGlassLine(String label, String val) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(label, style: TextStyle(fontWeight: FontWeight.w900, fontSize: 9, color: Colors.white.withOpacity(0.4))),
