    ...
    return Column(
      children: [
        Container(
          ...
          child: Icon(Iconsax.password_check, color: color.withValues(alpha: 0.4), size: 48),
        ),
          ...
          Container(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                prefixIcon: Icon(Iconsax.direct_right, color: color.withValues(alpha: 0.4), size: 22),
