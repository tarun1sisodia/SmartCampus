...
class VerifyEmailNeumorphism extends StatelessWidget {
  const VerifyEmailNeumorphism({super.key, this.email});
    ...
    return Column(
      children: [
        Container(
          ...
          child: const Icon(Iconsax.direct_send, color: Color(0xFFA3B1C6), size: 48),
        ),
        const SizedBox(height: 48),
  ...
  Widget _buildNeuData(String? email, Color bgColor) {
    return Container(
      ...
      child: Column(
        children: [
          Text(email ?? 'IDENTITY_NODE_PENDING', style: const TextStyle(fontWeight: FontWeight.w900, fontSize: 16, color: Color(0xFF4D565F))),
      ...
      children: [
        GestureDetector(
          ...
          child: Container(
            ...
            child: const Center(child: Text('PROCEED_VALIDATION', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 15, color: Color(0xFF4D565F), letterSpacing: 1))),
          ),
        ),
        const SizedBox(height: 32),
        GestureDetector(
          onTap: () => controller.sendEmailVerification(),
          child: const Text('RE_DISPATCH_UPLINK', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 9, color: Color(0xFFA3B1C6), letterSpacing: 2)),
        ),
      ],
    );
  }
