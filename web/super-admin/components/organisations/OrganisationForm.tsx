  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="card grid grid-cols-1 gap-3 md:grid-cols-2">
      <div className="md:col-span-2">
        ...
        <input className="w-full rounded border border-input px-3 py-2" {...register("name")} />
        {errors.name && <p className="mt-1 text-xs text-danger">{errors.name.message}</p>}
      </div>

      <div>
        <label className="mb-1 block text-sm text-muted-foreground">Type</label>
        <select className="w-full rounded border border-input px-3 py-2" {...register("type")}>
      ...
      <div>
        <label className="mb-1 block text-sm text-muted-foreground">Subscription Plan</label>
        <select
      ...
      <div>
        <label className="mb-1 block text-sm text-muted-foreground">Domain</label>
        <input className="w-full rounded border border-input px-3 py-2" {...register("domain")} />
      </div>
      ...
      <div>
        ...
        <select className="w-full rounded border border-input px-3 py-2" {...register("status")}>
