...
class ImportCupertino extends StatelessWidget {
  ...
  Widget _buildIosHeader() {
    return Column(
      ...
      children: const [
        ...
        Text('BULK_DATA_INGESTION_SYSTEM',
            style: TextStyle(
  ...
  Widget _iosFormatRow(RxString selectedFileType) {
    return Padding(
      ...
      child: Row(
        children: [
          _iosFormatCell('Excel', selectedFileType.value == 'Excel',
              () => selectedFileType.value = 'Excel', const Color(0xFF34C759)),
          const SizedBox(width: 12),
          _iosFormatCell('CSV', selectedFileType.value == 'CSV',
              () => selectedFileType.value = 'CSV', const Color(0xFF007AFF)),
        ],
      ),
    );
  }

  Widget _iosFormatCell(
  ...
  Widget _iosFileUpload(
      RxBool fileSelected, RxString fileName, RxString format) {
    return Obx(() => fileSelected.value
        ...
        : CupertinoButton(
            ...
            onPressed: () {
              ...
              fileName.value = 'DATA_UPLINK.${format.value.toUpperCase()}';
            },
            child: Center(
              child: Column(
                children: const [
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Obx(() => CupertinoSwitch(
              value: value.value, onChanged: (v) => value.value = v)),
        ],
      ),
    );
  }
