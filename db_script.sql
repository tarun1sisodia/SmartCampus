...
-- Note: Updated to match AttendanceRecordModel which has status values of 'present', 'absent', 'late'
...
-- =============================================
-- STEP 6: Create functions for statistics
-- =============================================
...
BEGIN
    ...
    IF p_status NOT IN ('present', 'absent', 'late', 'excused') THEN
        RAISE EXCEPTION 'Invalid status: %. Must be present, absent, late, or excused', p_status;
    END IF;
