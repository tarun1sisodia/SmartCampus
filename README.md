...
- **Class Management**: Organize classes by courses and subjects.
- **Student Management**: Enroll and manage students for each class.
- **Attendance Tracking**: Real-time attendance marking with detailed statistics.
- **Session Timer**: Track session duration with start and end times.
- **Dark and Light Themes**: Support for both dark and light modes.
- **Cross-Platform Compatibility**: Works on mobile, Windows, and Linux.
